...
\begin{figure}
  \centering
  \includegraphics[width=8cm]{Images/Circumplexes/justineCircumplex}
  \caption{Circumplex of Justine}
\end{figure}

\begin{figure}
  \centering
   \includegraphics[width=8cm]{Images/Evolutions/justineEvolution}
...
\subsection{Background story}
 After the curse has been broken, Justin decides to go back to Strangia to give orders to stop the war, but once he gets to the castle he gets imprisoned because his father ha died
