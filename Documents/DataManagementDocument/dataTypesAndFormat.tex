...
\textbf{PATH} & \textbf{WxH (px)} & \textbf{EDITOR} \\ \hline
\path{./Documents/Images/Characters/*} & 250x350 & Photoshop \\ \hline
\path{./Documents/Images/Diagrams/*.png} & - & Exported from the \textit{svg} file with the same name. \\ \hline
\path{./Documents/Images/Diagrams/*.svg} & - & Inkscape \\ \hline
\end{tabularx}
\end{table}
