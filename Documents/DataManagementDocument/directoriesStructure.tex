  ...
  \begin{itemize}
    ...
    \item \textbf{\path{/Characters}}: contains one portrait for each character.
      ...
      \item \textbf{\path{/Locations}}: contains one picture for each location.
        ...
        \item \textbf{\path{/Palettes}}: contains all the palettes used to indicate the locations/area color.
        \item \textbf{\path{/Machines}}: contains all the sketches used to show the Calcifer transformations in the game.
