...
Sophie leads the way to sow the guards and Justin follows her. Running away through Dynamia, Justin notices that the guards have blocked some ways and so advices Sophie.\\

\textbf{Justin}: Sophie, it is impossible to sow so many guards! Let's take a gondola. 

Sophie follows Justin's advice and leads them to the closest gondola.
