...
\hspace*{0.007cm}  \textbf{Manifest (solemn)}: She is our enlightened and beloved Queen regent. Long live the \\\hspace*{4.7cm} Queen!\\
...
\textbf{Merchant}: What a lonely girl is doing here?\\
...
\textbf{Newsboy}: Breaking news! Prince of Strangia accused of high treason and sentenced \hspace*{2.7cm}to death. Tomorrow morning the public execution!
...
\textbf{Lamp (ill-tempered)}: That worm is in the darkest and wettest brig. \\\hspace*{4.8cm} That way. Do you wanna join him?

\textbf{Sophie}: By any chance, have you heard of a wizard? Maybe he has been brought here.

\textbf{Lamp}: Wizard? What wizard? There’s no wizard down there. Now leave me alone. \hspace*{2.0cm}Me and my miserable job.\\
...
\textbf{Justin (surprised and worried)}: Sophie! Calcifer! Guys, what are you doing here!? \\\hspace*{6.9cm}It is so dangerous!

\textbf{Sophie}: We were looking for some information about Howl when we discovered that \hspace*{2.0cm} you had been imprisoned. You’ll be executed tomorrow!\\
...
\textbf{Justin}: Yes… I think the only way to open the door is stealing the key from the captain \hspace*{2.0cm} of the guards, but it is too risky… Go away and stay safe, leave me alone!

\textbf{Sophie and Calcifer}: We would never let you down. Where is the captain?

\textbf{Justin}: Thanks, guys. You are true friends. The captain typically stays in the guards' \hspace*{2.0cm}room, but I’ve heard he keeps always the door open to look what his underlings \hspace*{2.0cm}are doing. So, while he is distracted, you can get in and steal the passepartout \hspace*{2.0cm}key he holds attached to his belt.\\
...
\textbf{Sophie}: Not this time! We would draw too much attention!\\ \hspace*{2.1cm}Stay here and shout if someone is coming!\\
...
\textbf{Guard 2}: What? The prince is free! Alert all the guards! \\\hspace*{2.3cm} The prisoner is running away with a girl, let's take them!
...
\textbf{Boat}: Hello, Sophie. I’m here to help you. \\\hspace*{1.7cm}Tell me where you want to go and I will take you there. \\\hspace*{1.7cm}I’m yours to command.
