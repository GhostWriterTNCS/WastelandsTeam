\section{Machines}
During the game Calcifer can use some debris to temporarily transform his lantern in some useful machine.
...
In order to unlock a new machine the player has to reorder the pieces of a mosaic representing the machine itself.

The mosaic has 4 rows and 6 columns. The player can switch any couple of two pieces.

The number of tiles in the puzzle is different for each machine to gradually increase the difficulty for the player:
\begin{itemize}
