...
\begin{figure}[H]
  \centering
  \includegraphics[width=8cm]{Images/Diagrams/Circumplexes/calciferCircumplex}
  \caption{Circumplex of Calcifer}
\end{figure}

\begin{figure}[H]
  \centering
   \includegraphics[width=8cm]{Images/Diagrams/Evolutions/calciferEvolution}
...
He can use debris to build machines like the flying castle.

Howl created a magic lantern that allows Calcifer to safely leave the flying castle.
