...
\begin{table}[H]
  ...
  \begin{tabular}{l|c|}
    ...
    \rowcolor[HTML]{C0C0C0} 
    \multicolumn{1}{|l|}{\cellcolor[HTML]{C0C0C0}\textbf{Level}} & \textbf{Captain x1} \\ \hline
...
\rowcolor[HTML]{C0C0C0} 
\multicolumn{1}{|c|}{\cellcolor[HTML]{C0C0C0}\textbf{Level}} & \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}\textbf{AC}} & \textbf{Captain x1} \\ \hline
\multicolumn{1}{|c|}{1} &  &  \\ \hline
\multicolumn{1}{|c|}{2} &  &  \\ \hline
\end{tabular}
\end{table}
