...
\begin{table}[H]
  ...
  \efbox[backgroundcolor=white]{	
    ...
    \multicolumn{3}{c}{} \\
    \multicolumn{3}{c}{Website for references: \url{http://wastelandsteam.altervista.org/}} \\
    \multicolumn{3}{c}{Password: \textit{gld18}} \\
	\end{tabular}}
\end{table}
...
\input{LevelDescription/index}

\input{LevelStory/index}
