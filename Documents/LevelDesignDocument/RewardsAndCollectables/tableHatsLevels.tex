...
\textbf{Derby}                       & \raisebox{-0.3\height}{\includegraphics[height=1.5cm]{Images/Hats/derby}}              & First Steps                                                                        & +1 Intelligence                                                                      & Sophie is getting it in a tutorial level where she learns how to sew new hats.                                                        \\
\hline
%\textbf{A} & AA & Where is Howl  & AAA & AAAA \\ \hline
%\textbf{B} & BB & The imprisoned friend & BBB  & BBBB \\ \hline
\textbf{Suliman's hat} & \raisebox{-0.3\height}{\includegraphics[height=1.5cm]{Images/Hats/suliman}} & Nasty surprise(s)
...
\textbf{Winged helmet} & \raisebox{-0.3\height}{\includegraphics[height=1.5cm]{Images/Hats/helmetWings}} & Nel blu dipinto di blu & TODO  & Sophie is getting it in when she begins to drive the castle \\ \hline
\textbf{Desert} & \raisebox{-0.3\height}{\includegraphics[height=1.5cm]{Images/Hats/desert}} & The last hope & \begin{tabular}[c]{@{}l@{}}+3 HP\\ +1 Consitution\\ -1 AC\\ -1 Charisma\end{tabular} & Sophie can give Belzel some of her crafter materials in exchange of this
\\ \hline
\textbf{Wolf spirit} & \raisebox{-0.3\height}{\includegraphics[height=1.5cm]{Images/Hats/wolfSpirit}} & The spirits realm & TODO
...
\textbf{Sultan of piety} & \raisebox{-0.3\height}{\includegraphics[height=1.5cm]{Images/Hats/sultanPiety}} &
...
\textbf{Sultan of vengeance} & \raisebox{-0.3\height}{\includegraphics[height=1.5cm]{Images/Hats/sultanVengeance}} &
