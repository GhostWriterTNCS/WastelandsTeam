...
\item \textbf{Clothes}: these objects are special clothes that Sophie may get during the game and they provide some useful effects only in the level they are found. %depending on where Sophie is.  
  \end{enumerate}
