...
When the player is closer than 50 meters to an NPC that is involved in a secondary mission, that NPC is highlighted with an exclamation mark.
...
\textbf{Reward}: TODO (a rare material), TODO Exp.
