...
The player can visit only the hall of the medical office, that is quite messy because there are a lot of patients, so the nurses has prepared some makeshift beds in the hall.
...
In order to exit the warehouse, the player has to push some boxes to create a stair and reach the open window. Calcifer cannot push the boxes with the barrel and cannot pull any box.
