...
\begin{center}
  \begin{figure}[H]
    \centering
    \vspace*{30pt}
    \includegraphics[width=12cm]{Images/Logos/logoTeam}
  \end{figure}
  ...
  \scalebox{1.5}{\contour{black}{ \textbf{ \textcolor{white}{\large \textbf{\textit{PONG - Game and Level Design}}}}}}
\end{center}
...
\begin{table}[H]
  \centering
  {\transparent{0.1} % QUESTO TRANSPARENT NON FUNZIONA
