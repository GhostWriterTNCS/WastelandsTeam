...
If you need to create new documents, use the template file \textit{template.tex} in \textit{Documents} folder.
...
\end{itemize}
    ...
    \item \textbf{\path{./References}}: contains all the reference files.
      \begin{itemize}
        \item \textbf{\path{./Images}}: contains all the reference images grouped in folders by argument.
        \end{itemize}
\end{itemize}
