...
\item \textbf{Documents} : inside this directory there is each file that composes the current level design document and all the images.
  \begin{itemize}
  \item levelDesignDocument.tex : this is the current level-design-document file. It contains many references to the LaTeX files that compose it.
    ...
    \item \textbf{GoalsOutline}:
      ...
      \item \textbf{Synopsis}
      \end{itemize}
    \item dataManagmentDocument.tex: this is the current data-managment-document file. It learns you everythings about the project.
  \end{itemeize}
